...
from lib_orig.attention_wrapper import TemporalPatternAttentionCellWrapper
...
class PolyRNN:
    ...
    def _build_graph(self):
        ...
        # [BEN MA]: the data_generator.inputs function prepares the dataset from the appropriate .tfrecords file and
        # returns the iterator to go over the elements
