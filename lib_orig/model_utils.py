...
from lib_orig.model import PolyRNN


def create_data_generator(para):
    if para.data_set == 'lpd5':
        from lib_orig.data_generator import LPD5DataGenerator
        return LPD5DataGenerator(para)
    elif para.data_set == 'muse':
        from lib_orig.data_generator import MuseDataGenerator
        return MuseDataGenerator(para)
    elif para.mts:
        from lib_orig.data_generator import TimeSeriesDataGenerator
